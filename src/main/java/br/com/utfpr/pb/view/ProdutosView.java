...
public class ProdutosView extends javax.swing.JInternalFrame {
    ...
    public ProdutosView() {
        try {
            controller = ProdutoController.getInstance();
    ...
    private void add(Produto produto) {
        ...
        vetor[3] = DoubleUtil.getInstance().format(produto.getValor());
        vetor[4] = produto.getEstoque();
        vetor[5] = produto.getAtivoTxt();
        model.addRow(vetor);
    }

    private void openModal() {
        ProdutoView produtoView = new ProdutoView(null, true);
        produtoView.setProduto(getSelecionado());
    ...
    private void initComponents() {
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Descrição", "Categoria", "Valor", "Estoque", "Ativo"
            }
        ) {
