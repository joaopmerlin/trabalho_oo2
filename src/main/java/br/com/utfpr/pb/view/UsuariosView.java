...
public class UsuariosView extends javax.swing.JInternalFrame {
    ...
    private void add(Usuario usuario) {
        ...
        vetor[0] = usuario.getId();
        vetor[1] = usuario.getLogin();
        vetor[2] = usuario.getNome();
        model.addRow(vetor);
    }

    private void openModal() {
        UsuarioView usuarioView = new UsuarioView(null, true);
        usuarioView.setUsuario(getSelecionado());
    ...
    private void pesquisa() {
        ...
        data.stream()
                .filter(e -> StringUtils.containsIgnoreCase(e.getId().toString(), query) ||
                        ...
                        StringUtils.containsIgnoreCase(e.getLogin(), query))
