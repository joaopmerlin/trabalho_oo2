 ...
 * @author João
 */
public class RelatorioContasView extends javax.swing.JInternalFrame {
    ...
    private void gerar(){
        ...
        if (pendente.isSelected()){
            parametros.put("pendente", 1);
        } else {
            parametros.put("pendente", 0);
        }
        
        try {
            GeraRelatorio.jasper("contas", parametros);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void initComponents() {
        ...
        pendente = new javax.swing.JCheckBox();
        ...
        pendente.setText("Somente títulos em aberto");
    ...
    private javax.swing.JCheckBox pendente;
