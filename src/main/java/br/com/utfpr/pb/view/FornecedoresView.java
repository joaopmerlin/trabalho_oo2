...
public class FornecedoresView extends javax.swing.JInternalFrame {
    ...
    public FornecedoresView() {
        try {
            controller = FornecedorController.getInstance();
    ...
    private void add(Fornecedor fornecedor) {
        ...
        vetor[0] = fornecedor.getId();
        vetor[1] = fornecedor.getNome();
        vetor[2] = fornecedor.getTelefone();
        vetor[3] = fornecedor.getCidade();
        vetor[4] = fornecedor.getAtivoTxt();
        model.addRow(vetor);
    }

    private void openModal() {
        FornecedorView fornecedorView = new FornecedorView(null, true);
        fornecedorView.setFornecedor(getSelecionado());
    ...
    private void pesquisa() {
        ...
        data.stream()
                .filter(e -> StringUtils.containsIgnoreCase(e.getId().toString(), query) ||
                        StringUtils.containsIgnoreCase(e.getNome(), query))
