 ...
 * @author João
 */
public class RelatorioProdutosMaisVendidosView extends javax.swing.JInternalFrame {
     ...
     */
    public RelatorioProdutosMaisVendidosView() {
        try {
    ...
    private void gerar(){
        ...
        try {
            GeraRelatorio.jasper("produtosmaisvendidos", parametros);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
