...
public class ClientesView extends javax.swing.JInternalFrame {
    ...
    private void add(Cliente cliente) {
        ...
        vetor[0] = cliente.getId();
        vetor[1] = cliente.getNome();
        vetor[2] = cliente.getTelefone();
        vetor[3] = cliente.getCidade();
        vetor[4] = cliente.getAtivoTxt();
        model.addRow(vetor);
    }

    private void openModal() {
        ClienteView clienteView = new ClienteView(null, true);
        clienteView.setCliente(getSelecionado());
